 ...
 */
final class Version20220507174400 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne ADD user_id INT NOT NULL');
